...
const privacy = () => {
  ...
  <div className="row">
    ...
    <h1 className="text-center heading heading-2">Privacy Policy</h1><hr/>


  <p>
    At sweetdevelopers.com, accessible from http://sweetdevelopers.com/,
    ...
    by sweetdevelopers.com and how we use it.
  </p>
  <p>
  ...
  <p>
    ...
    and/or collect in sweetdevelopers.com. This policy is not applicable to
  ...
  <h4>Log Files</h4>
  <p>
    sweetdevelopers.com follows a standard procedure of using log files.
  ...
  <p>
    Like any other website, sweetdevelopers.com uses "cookies". These cookies
  ...
  <p>
    ...
    advertising partners of sweetdevelopers.com.
  </p>
  <p>
    Third-party ad servers or ad networks uses technologies like cookies,
    JavaScript, or Web Beacons that are used in their respective advertisements
    and links that appear on sweetdevelopers.com, which are sent directly to
  ...
  <p>
    Note that sweetdevelopers.com has no access to or control over these
    cookies that are used by third-party advertisers.
  </p>
  <h4>Third Party Privacy Policies</h4>
  <p>
    sweetdevelopers.com's Privacy Policy does not apply to other advertisers
  ...
  <p>
    sweetdevelopers.com does not knowingly collect any Personal Identifiable
